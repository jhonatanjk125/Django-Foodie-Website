...
SECRET_KEY = 'django-insecure-2v5()3hj@a9htitqz2h^2tixm9%7+hlf$sr4fg2i-(z)(r)u9r'
...
os.environ['PROJ_LIB'] = os.path.join(BASE_DIR, 'venv\Libs\ite-packages\osgeo\data\proj') + ';' + os.environ['PATH']
